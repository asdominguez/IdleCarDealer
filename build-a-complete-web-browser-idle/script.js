...
const VEHICLE_POOL = [
  ["Toyota", "Supra", 1997, 42], ["Honda", "S2000", 2005, 28], ["Ford", "Bronco", 1974, 34],
  ["Chevrolet", "Corvette Z06", 2008, 74], ["Porsche", "911 Carrera", 2012, 96], ["BMW", "M3", 2011, 68],
  ["Mercedes-Benz", "G-Wagen", 2016, 125], ["Nissan", "GT-R", 2015, 110], ["Dodge", "Viper", 2006, 92],
  ["Land Rover", "Defender", 1995, 46], ["Audi", "R8", 2014, 138], ["Lexus", "LC 500", 2018, 102]
];
...
function getAuctionRenderSignature() {
  ...
  return [
    activeAuctionTab,
    Math.floor(state.cash / 1_000_000_000),
